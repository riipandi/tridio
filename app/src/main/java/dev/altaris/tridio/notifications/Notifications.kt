 ...
 *
 */
package dev.altaris.tridio.notifications
...
import dev.altaris.tridio.constants.Constants.ACTION_PLAY_PAUSE
...
class RealNotifications(
    ...
    private fun getPreviousAction(context: Context): NotificationCompat.Action {
        val actionIntent = Intent(context, TridioMusicService::class.java).apply {
