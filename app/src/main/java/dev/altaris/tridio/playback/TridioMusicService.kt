...
import dev.altaris.tridio.constants.Constants
import dev.altaris.tridio.constants.Constants.ACTION_NEXT
import dev.altaris.tridio.constants.Constants.ACTION_PREVIOUS
import dev.altaris.tridio.constants.Constants.APP_PACKAGE_NAME
import dev.altaris.tridio.db.QueueEntity
import dev.altaris.tridio.db.QueueHelper
import dev.altaris.tridio.extensions.attachLifecycle
import dev.altaris.tridio.extensions.isPlayEnabled
import dev.altaris.tridio.extensions.isPlaying
import dev.altaris.tridio.extensions.toIDList
import dev.altaris.tridio.extensions.toRawMediaItems
import dev.altaris.tridio.models.MediaID
import dev.altaris.tridio.models.MediaID.Companion.CALLER_OTHER
import dev.altaris.tridio.models.MediaID.Companion.CALLER_SELF
import dev.altaris.tridio.notifications.Notifications
import dev.altaris.tridio.permissions.PermissionsManager
...
import dev.altaris.tridio.repository.GenreRepository
import dev.altaris.tridio.repository.PlaylistRepository
import dev.altaris.tridio.repository.SongsRepository
import dev.altaris.tridio.util.Utils.EMPTY_ALBUM_ART_URI
...
class TridioMusicService : MediaBrowserServiceCompat(), KoinComponent, LifecycleOwner {
