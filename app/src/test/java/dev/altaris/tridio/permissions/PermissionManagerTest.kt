 ...
 *
 */
package dev.altaris.tridio.permissions
...
import dev.altaris.tridio.TridioApp
import dev.altaris.tridio.permissions.RealPermissionsManager.Companion.REQUEST_CODE_STORAGE
...
@Config(manifest = Config.NONE, sdk = [28], application = TridioApp::class)
